 ...
 *	Returns	: none
 */
CThreeDModel::CThreeDModel(float Material_Amb[4], float Material_Dif[4], float Material_Spec[4], float Material_Shin)
	:Material_Ambient{ Material_Amb[0], Material_Amb[1], Material_Amb[2], Material_Amb[3]},
	Material_Diffuse{ Material_Dif[0], Material_Dif[1], Material_Dif[2], Material_Dif[3] },
	Material_Specular{ Material_Spec[0], Material_Spec[1], Material_Spec[2], Material_Spec[3] },
	Material_Shininess(Material_Shin)
{
...
{
	double DISTANCE_TO_VERTEX = 0.0005;
